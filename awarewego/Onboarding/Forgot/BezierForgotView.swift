...
class BezierForgotView: UIView {
    ...
    func drawInvertedCurvedBG(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 376, height: 69), resizing: BezierResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Background Drawing
        let backgroundPath = UIBezierPath()
        backgroundPath.move(to: CGPoint(x: 386.12, y: 55.85))
        backgroundPath.addCurve(to: CGPoint(x: 317.09, y: 24.72), controlPoint1: CGPoint(x: 362.47, y: 47.25), controlPoint2: CGPoint(x: 340.56, y: 33.86))
        backgroundPath.addCurve(to: CGPoint(x: -35.66, y: 18.48), controlPoint1: CGPoint(x: 205.78, y: -18.66), controlPoint2: CGPoint(x: 81.27, y: 38.69))
        backgroundPath.addCurve(to: CGPoint(x: -303.81, y: -75.82), controlPoint1: CGPoint(x: -128.8, y: 2.39), controlPoint2: CGPoint(x: -210.38, y: -61.82))
        backgroundPath.addCurve(to: CGPoint(x: -451.35, y: -78.3), controlPoint1: CGPoint(x: -352.57, y: -83.13), controlPoint2: CGPoint(x: -402.15, y: -76.35))
        backgroundPath.addCurve(to: CGPoint(x: -607.65, y: 340.95), controlPoint1: CGPoint(x: -500.55, y: -80.25), controlPoint2: CGPoint(x: -608.02, y: 183.48))
        backgroundPath.addCurve(to: CGPoint(x: -345.69, y: 391.25), controlPoint1: CGPoint(x: -522.83, y: 331.6), controlPoint2: CGPoint(x: -430.62, y: 383.29))
        backgroundPath.addCurve(to: CGPoint(x: 828.92, y: 400.51), controlPoint1: CGPoint(x: 41.1, y: 427.49), controlPoint2: CGPoint(x: 441.98, y: 434.73))
        backgroundPath.addCurve(to: CGPoint(x: 828.92, y: 311.94), controlPoint1: CGPoint(x: 835.58, y: 399.92), controlPoint2: CGPoint(x: 824.4, y: 317.21))
        backgroundPath.addCurve(to: CGPoint(x: 833.7, y: 292.22), controlPoint1: CGPoint(x: 833.33, y: 306.82), controlPoint2: CGPoint(x: 833.69, y: 299.18))
        backgroundPath.addLine(to: CGPoint(x: 833.7, y: 291.37))
        backgroundPath.addCurve(to: CGPoint(x: 802.06, y: 91.56), controlPoint1: CGPoint(x: 833.7, y: 223.52), controlPoint2: CGPoint(x: 823.02, y: 156.09))
        backgroundPath.addCurve(to: CGPoint(x: 718.78, y: 6.78), controlPoint1: CGPoint(x: 786.44, y: 42.82), controlPoint2: CGPoint(x: 773.42, y: 10.33))
        backgroundPath.addCurve(to: CGPoint(x: 616.3, y: 31.03), controlPoint1: CGPoint(x: 683.63, y: 4.49), controlPoint2: CGPoint(x: 648.76, y: 18.33))
        backgroundPath.addCurve(to: CGPoint(x: 386.12, y: 55.85), controlPoint1: CGPoint(x: 542.4, y: 59.96), controlPoint2: CGPoint(x: 460.6, y: 82.96))
        backgroundPath.close()
        fillColor.setFill()
        backgroundPath.fill()
